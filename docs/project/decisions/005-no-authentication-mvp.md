...
**SUPERSEDED** | **Fecha Original:** 2025-10-25 | **Superseded:** 2025-11-10

**Superseded by:** [ADR-006: Better Auth con Sistema de Invitaciones](./006-better-auth-invitation-system.md)

---

**⚠️ NOTA:** Esta decisión fue correcta para el MVP inicial pero fue reemplazada cuando los requisitos cambiaron. Ver ADR-006 para el sistema de autenticación actual implementado con Better Auth y sistema de invitaciones.

**Razón del cambio:** El usuario solicitó control de acceso explícito para proteger datos confidenciales de la empresa. El contexto cambió de "herramienta interna red local 1-2 usuarios" a "herramienta con datos confidenciales que requiere control de quién accede".
